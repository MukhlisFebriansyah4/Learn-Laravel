        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <form action='' method='post'>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='judul' id="judul" value="{{ isset($data['judul']) ? $data['judul'] : '' }}">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="nama" class="col-sm-2 col-form-label">Pengarang</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='pengarang' id="pengarang" value="{{ isset($data['pengarang']) ? $data['pengarang'] : '' }}">
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{isset($data['tanggal_publikasi']) ? $data['tanggal_publikasi'] : ''}}"
                        >
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <form class="d-inline" action="{{url('buku/'.$item['id'])}}" method="post" onsubmit="return confirm('Apakah yakin akan mengapus data?')">
                                    @csrf
                                    @method('delete')
